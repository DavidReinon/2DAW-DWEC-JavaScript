let attributes = [
    [
        ...
        { type: "placeholder", name: "Nombre" },
        { type: "type", name: "text" },
        { type: "name", name: "name" },
    ],
    [
        { type: "class", name: "input" },
        { type: "placeholder", name: "Primer Apellido" },
        { type: "type", name: "text" },
        { type: "name", name: "first-surname" },
    ],
    [
        { type: "class", name: "input" },
        { type: "placeholder", name: "Segundo Apellido" },
        { type: "type", name: "text" },
        { type: "name", name: "second-surname" },
    ],
    [
        { type: "class", name: "input" },
        { type: "placeholder", name: "Telefono" },
        { type: "type", name: "text" },
        { type: "name", name: "phone-number" },
    ],
    [
        { type: "class", name: "send" },
        { type: "placeholder", name: "Enviar" },
...
function onSubmit(event) {
    ...
    let names = [
        { category: "name", value: "nombre" },
        { category: "first-surname", value: "primer apellido" },
        { category: "second-surname", value: "segundo apellido" },
    ];
    let test = true;
